                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>8.</b> You will be provided with safety equipment. <?= soal_isian_ielts("jawaban_reading[7]", $listening_reading[47][1], $listening_reading[47][2])?></p>
                                                        <p><b>9.</b> You may get some minor injuries doing this activity  <?= soal_isian_ielts("jawaban_reading[8]", $listening_reading[48][1], $listening_reading[48][2])?></p>
                                                        <p><b>10.</b> You can see a disused, isolated building <?= soal_isian_ielts("jawaban_reading[9]", $listening_reading[49][1], $listening_reading[49][2])?></p>
                                                        <p><b>11.</b> You can relax and look down from above in an unusual location. <?= soal_isian_ielts("jawaban_reading[10]", $listening_reading[50][1], $listening_reading[50][2])?></p>
                                                        <p><b>12.</b> You will take an exciting trip in rough water close to big ships. <?= soal_isian_ielts("jawaban_reading[11]", $listening_reading[51][1], $listening_reading[51][2])?></p>
                                                        <p><b>13.</b> You can choose easy options or more diﬃcult ones. <?= soal_isian_ielts("jawaban_reading[12]", $listening_reading[52][1], $listening_reading[52][2])?></p>
                                                        <p><b>14.</b> You may ﬁnd this more diﬃcult than you expect. <?= soal_isian_ielts("jawaban_reading[13]", $listening_reading[53][1], $listening_reading[53][2])?></p>
                                                ...
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <ul type="radio">
                                                            ...
                                                            <li>Events such as 15 <?= soal_isian_ielts("jawaban_reading[14]", $listening_reading[54][1], $listening_reading[54][2])?> for local and visiting schools </li>
                                                        ...
                                                        <ul type="radio">
                                                            ...
                                                            <li>be responsible for keeping to the <b>16)</b> <?= soal_isian_ielts("jawaban_reading[15]", $listening_reading[55][1], $listening_reading[55][2])?> </li>
                                                            <li>build <b>17)</b><?= soal_isian_ielts("jawaban_reading[16]", $listening_reading[56][1], $listening_reading[56][2])?>. with other organisations </li>
                                                            <li>be proactive in fundraising </li>
                                                            <li>increase the focus on <b>18)</b> <?= soal_isian_ielts("jawaban_reading[17]", $listening_reading[57][1], $listening_reading[57][2])?> in school music lessons (e.g., international styles) </li>
                                                            <li>make sure records and a <b>19)</b> <?= soal_isian_ielts("jawaban_reading[18]", $listening_reading[58][1], $listening_reading[58][2])?>. is kept up-to-date</li>
                                                        </ul>

                                                        <p><b>Person appointed must have</b></p>
                                                        <ul type="radio">
                                                            <li>ability to supervise and motivate others </li>
                                                            <li>basic knowledge of <b>20)</b> <?= soal_isian_ielts("jawaban_reading[19]", $listening_reading[59][1], $listening_reading[59][2])?></li>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>21.</b> One cause of health and safety problems in small businesses is that managers do not have enough relevant <?= soal_isian_ielts("jawaban_reading[20]", $listening_reading[60][1], $listening_reading[60][2])?></p>
                                                        <p><b>22.</b> Managers complain they have too many <?= soal_isian_ielts("jawaban_reading[21]", $listening_reading[61][1], $listening_reading[61][2])?> to deal with.</p>
                                                        <p><b>23.</b> Managers may not fully understand their <?= soal_isian_ielts("jawaban_reading[22]", $listening_reading[62][1], $listening_reading[62][2])?></p>
                                                        <p><b>24.</b> Businesses sometimes feel that inspectors give them far too many <?= soal_isian_ielts("jawaban_reading[23]", $listening_reading[63][1], $listening_reading[63][2])?></p>
                                                        <p><b>25.</b> Businesses above a certain size must produce a written <?= soal_isian_ielts("jawaban_reading[24]", $listening_reading[64][1], $listening_reading[64][2])?> of their health and safety policy.</p>
                                                        <p><b>26.</b> A company’s health and safety policy is relevant to both its employees and its <?= soal_isian_ielts("jawaban_reading[25]", $listening_reading[65][1], $listening_reading[65][2])?></p>
                                                        <p><b>27.</b> The Health and Safety Executive can advise small businesses on problems of <?= soal_isian_ielts("jawaban_reading[26]", $listening_reading[66][1], $listening_reading[66][2])?> among their employees</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>33.</b> was unable to work at certain times <?= soal_isian_ielts("jawaban_reading[32]", $listening_reading[72][1], $listening_reading[72][2])?></p>
                                                        <p><b>34.</b> divided workers into groups <?= soal_isian_ielts("jawaban_reading[33]", $listening_reading[73][1], $listening_reading[73][2])?></p>
                                                        <p><b>35.</b> faced daily hazards <?= soal_isian_ielts("jawaban_reading[34]", $listening_reading[74][1], $listening_reading[74][2])?></p>
                                                        <p><b>36.</b> underwent a long period of training <?= soal_isian_ielts("jawaban_reading[35]", $listening_reading[75][1], $listening_reading[75][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>Labourers who worked on the king’s buildings were local people who chose to participate in <b>37)</b> <?= soal_isian_ielts("jawaban_reading[36]", $listening_reading[76][1], $listening_reading[76][2])?> or who received payment.</p>
                                                        <p>The work involved breaking up stone cliffs using wooden wedges. The large pieces of stone were then transported to another site on sleds, which moved easily over the <b>38)</b> <?= soal_isian_ielts("jawaban_reading[37]", $listening_reading[77][1], $listening_reading[77][2])?> Here, the blocks could be cut and shaped using tools made of <b>39)</b> <?= soal_isian_ielts("jawaban_reading[38]", $listening_reading[78][1], $listening_reading[78][2])?> and wood. Some of these had to be sharpened regularly.</p>
                                                        <p>Eventually, the stone was moved into place to create a building. The job of moving the Stone was often done by <b>40)</b> <?= soal_isian_ielts("jawaban_reading[39]", $listening_reading[79][1], $listening_reading[79][2])?> or other unskilled workers.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
