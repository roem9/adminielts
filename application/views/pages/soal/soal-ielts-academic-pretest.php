                            ...
                            <div class="sesi-listening" style="display:nones">
                                        ...
                                        <center>
                                            <table class="table" style="width:100%">
                                                <tr>
                                                    ...
                                                    <td>No.1 Yeronga St., <b>1)</b><?= soal_isian_ielts("jawaban_listening[0]", $listening_reading[0][1], $listening_reading[0][2])?></td>
                                                </tr>
                                                <tr>
                                                    <td>Telephone Number:</td>
                                                    <td><b>2)</b><?= soal_isian_ielts("jawaban_listening[1]", $listening_reading[1][1], $listening_reading[1][2])?> (home)</td>
                                                </tr>
                                                <tr>
                                                    <td>Respondent:</td>
                                                ...
                                                <tr>
                                                    <td>Address:</td>
                                                    <td><b>4)</b><?= soal_isian_ielts("jawaban_listening[3]", $listening_reading[3][1], $listening_reading[3][2])?> Avenue, Bardon </td>
                                                </tr>
                                                <tr>
                                                    <td>Postcode:</td>
                                                ...
                                                <tr>
                                                    <td>(+) Goods:</td>
                                                    <td><b>7)</b><?= soal_isian_ielts("jawaban_listening[6]", $listening_reading[6][1], $listening_reading[6][2])?></td>
                                                </tr>
                                                <tr>
                                                    <td>(+) Agreed to pay:</td>
                                                    <td><b>8)</b><?= soal_isian_ielts("jawaban_listening[7]", $listening_reading[7][1], $listening_reading[7][2])?> pounds</td>
                                                </tr>
                                                <tr>
                                                    <td>(+) Advantages</td>
                                                    <td>Reduces the amount of <b>9)</b><?= soal_isian_ielts("jawaban_listening[8]", $listening_reading[8][1], $listening_reading[8][2])?> used</td>
                                                </tr>
                                                <tr>
                                                    <td>(+) Complaint</td>
                                                    <td>The appliance is very <b>10)</b><?= soal_isian_ielts("jawaban_listening[9]", $listening_reading[9][1], $listening_reading[9][2])?></td>
                                                </tr>
                                ...
                                <div class="shadow card mb-3 soal">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>11)</b> The coach is comfortable because it is <?= soal_isian_ielts("jawaban_listening[10]", $listening_reading[10][1], $listening_reading[10][2])?>.</p>
                                        <p><b>12)</b> After all passengers are aboard, the coach will make its first stop at <?= soal_isian_ielts("jawaban_listening[11]", $listening_reading[11][1], $listening_reading[11][2])?> island. </p>
                                        <p><b>13)</b> The ‘Tree Top Walk’ is above a/an <?= soal_isian_ielts("jawaban_listening[12]", $listening_reading[12][1], $listening_reading[12][2])?>.</p>
                                        <p><b>14)</b> Passengers will have a/an <?= soal_isian_ielts("jawaban_listening[13]", $listening_reading[13][1], $listening_reading[13][2])?> with the alpacas before boarding the bus for home. </p>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3 soal">
                                    <div class="card-body ps-4">
                                        ...
                                        <center>
                                            <table class="table" style="width:100%">
                                                <tr>
                                                    <td colspan=2>Bookings at <b>15)</b> <?= soal_isian_ielts("jawaban_listening[14]", $listening_reading[14][1], $listening_reading[14][2])?> or Tel: 07 5562 4402</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=2><b>16)</b> <?= soal_isian_ielts("jawaban_listening[15]", $listening_reading[15][1], $listening_reading[15][2])?> Tour</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    <td><b>17)</b> <?= soal_isian_ielts("jawaban_listening[16]", $listening_reading[16][1], $listening_reading[16][2])?>                       $33.00</td>
                                                    <td>-Burleigh &emsp;&emsp; 8.10AM</td>
                                                </tr>
                                                <tr>
                                                    <td>Children (4-14 years) &emsp;&emsp; $10.00</td>
                                                    <td>-Surfers Paradise      <b>18)</b> <?= soal_isian_ielts("jawaban_listening[17]", $listening_reading[17][1], $listening_reading[17][2])?></td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><b>19)</b> <?= soal_isian_ielts("jawaban_listening[18]", $listening_reading[18][1], $listening_reading[18][2])?> only.</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=2>Free pick-up from your resort, hotel or motel.</td>
                                                </tr>
                                                <tr>
                                                    <td colspan=2>Not included in the fare: optional tours, luncheons, morning and afternoon tea (unless otherwise specified), <b>20)</b> <?= soal_isian_ielts("jawaban_listening[19]", $listening_reading[19][1], $listening_reading[19][2])?>.</td>
                                                </tr>
                                                <tr>
                                    ...
                                    <div class="card-body ps-4">
                                        ...
                                        <div class="row">
                                            <div class="col-6">
                                                ...
                                                <p><b>26)</b> Sharon and Lester have different		: <?= soal_isian_ielts("jawaban_listening[25]", $listening_reading[25][1], $listening_reading[25][2])?></p>
                                                <p><b>27)</b> Sharon and Lester help students’		: <?= soal_isian_ielts("jawaban_listening[26]", $listening_reading[26][1], $listening_reading[26][2])?></p>
                                                <p><b>28)</b> The program is well underway		: <?= soal_isian_ielts("jawaban_listening[27]", $listening_reading[27][1], $listening_reading[27][2])?></p>
                                                <p><b>29)</b> The liaison officer is impressed by	: <?= soal_isian_ielts("jawaban_listening[28]", $listening_reading[28][1], $listening_reading[28][2])?></p>
                                                <p><b>30)</b> Students are encouraged to take part in	: <?= soal_isian_ielts("jawaban_listening[29]", $listening_reading[29][1], $listening_reading[29][2])?></p>
                                            </div>
                                            <div class="col-6">
                                                <table class="table">
                                                    <tr>
                                ...
                                <div class="shadow card mb-3 soal">
                                    <div class="card-body ps-4">
                                        ...
                                        <ul type="bullet">
                                            <li>someone in an anxiety state has worse 31) <?= soal_isian_ielts("jawaban_listening[30]", $listening_reading[30][1], $listening_reading[30][2])?></li>
                                            <li>a phobia may stem from heredity or 32) <?= soal_isian_ielts("jawaban_listening[31]", $listening_reading[31][1], $listening_reading[31][2])?> problems</li>
                                            <li>the reason for the final breakdown is generally linked with 33) <?= soal_isian_ielts("jawaban_listening[32]", $listening_reading[32][1], $listening_reading[32][2])?> occurrences</li>
                                        </ul>
                                        <p><b>Phobic states:</b></p>
                                        <ul type="bullet">
                                            <li>Agoraphobia		: fears leaving the home 34) <?= soal_isian_ielts("jawaban_listening[33]", $listening_reading[33][1], $listening_reading[33][2])?></li>
                                            <li>Claustrophobia	: fears small 35) <?= soal_isian_ielts("jawaban_listening[34]", $listening_reading[34][1], $listening_reading[34][2])?></li>
                                            <li>
                                            Social phobia		: <br>
                                                                a. feels extremely shy in the 36) <?= soal_isian_ielts("jawaban_listening[35]", $listening_reading[35][1], $listening_reading[35][2])?> of people<br>
                                                                b. becomes 37) <?= soal_isian_ielts("jawaban_listening[36]", $listening_reading[36][1], $listening_reading[36][2])?> in front of other people<br>
                                                                c. gets sweaty 38) <?= soal_isian_ielts("jawaban_listening[37]", $listening_reading[37][1], $listening_reading[37][2])?> of the body
                                            </li>
                                            <li>
                                                Single phobia		: <br>
                                                                    a. has a deep-seated 39) <?= soal_isian_ielts("jawaban_listening[38]", $listening_reading[38][1], $listening_reading[38][2])?> to particular creatures<br>
                                                                    b. fears of the 40) <?= soal_isian_ielts("jawaban_listening[39]", $listening_reading[39][1], $listening_reading[39][2])?>
                                            </li>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>1. <?= soal_isian_ielts("jawaban_reading[0]", $listening_reading[40][1], $listening_reading[40][2])?> Use of chemical fertilizer can be optimised by combining weather information.</p>
                                                        <p>2. <?= soal_isian_ielts("jawaban_reading[1]", $listening_reading[41][1], $listening_reading[41][2])?> Organic framing yield is nearly equal to traditional ones.</p>
                                                        <p>3. <?= soal_isian_ielts("jawaban_reading[2]", $listening_reading[42][1], $listening_reading[42][2])?> Better agricultural setting is a significant key to solve environmental tough nut.</p>
                                                        <p>4. <?= soal_isian_ielts("jawaban_reading[3]", $listening_reading[43][1], $listening_reading[43][2])?> Substantial production loss would happen in case all farmers shifted from using synthetic fertiliser.</p>
                                                        ...
                                                        <?php
                                                            $data_soal_5_9 = [
                                                                [ 
                                                                    ...
                                                                    "jawaban" => $listening_reading[44][1],
                                                                    "status" => $listening_reading[44][2],
                                                                ],
                                                                [ 
                                                                    "no" => 6, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[45][1],
                                                                    "status" => $listening_reading[45][2],
                                                                ],
                                                                [ 
                                                                    "no" => 7, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[46][1],
                                                                    "status" => $listening_reading[46][2],
                                                                ],
                                                                [ 
                                                                    "no" => 8, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[47][1],
                                                                    "status" => $listening_reading[47][2],
                                                                ],
                                                                [ 
                                                                    "no" => 9, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[48][1],
                                                                    "status" => $listening_reading[48][2],
                                                                ],
                                                            ];
                                                        ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    ...
                                                    <p>
                                                        Several <b>(10)</b><?= soal_isian_ielts("jawaban_reading[9]", $listening_reading[49][1], $listening_reading[49][2])?>.approaches need to be applied in order that global population wouldn’t go starved. A team called <b>(11)</b><?= soal_isian_ielts("jawaban_reading[10]", $listening_reading[50][1], $listening_reading[50][2])?>.repeated the viewpoint of a scholar by survey in British farming. More and more European farmers believe in <b>(12)</b><?= soal_isian_ielts("jawaban_reading[11]", $listening_reading[51][1], $listening_reading[51][2])?>. farming these years. The argument of organic against <b>(13)</b> <?= soal_isian_ielts("jawaban_reading[12]", $listening_reading[52][1], $listening_reading[52][2])?>.seems in an inaccurate direction.
                                                    </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    ...
                                                    <p class="question">
                                                        ...
                                                        <p>14. Ancient stories around the pearl and customers.<?= soal_isian_ielts("jawaban_reading[13]", $listening_reading[53][1], $listening_reading[53][2])?></p>
                                                        <p>15. Difficulties in cultivating process.<?= soal_isian_ielts("jawaban_reading[14]", $listening_reading[54][1], $listening_reading[54][2])?></p>
                                                        <p>16. Factors can decide the value of natural pearls.<?= soal_isian_ielts("jawaban_reading[15]", $listening_reading[55][1], $listening_reading[55][2])?></p>
                                                        <p>17. Different growth mechanisms distinguish the cultured pearls from natural ones.<?= soal_isian_ielts("jawaban_reading[16]", $listening_reading[56][1], $listening_reading[56][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>
                                                            In ancient history, pearls have great importance within the rich and rulers, which was treated as gem for women in <b>(18)</b><?= soal_isian_ielts("jawaban_reading[17]", $listening_reading[57][1], $listening_reading[57][2])?>., and pearls were even used as medicine and sex drug for drug for people in <b>(19)</b><?= soal_isian_ielts("jawaban_reading[18]", $listening_reading[58][1], $listening_reading[58][2])?> There are essentially three types of pearls: natural, cultured and imitation. Most freshwater cultured pearls sold today come from China while the <b>(20)</b><?= soal_isian_ielts("jawaban_reading[19]", $listening_reading[59][1], $listening_reading[59][2])?>.is famous for its imitation pearl industry. The country <b>(21)</b><?= soal_isian_ielts("jawaban_reading[20]", $listening_reading[60][1], $listening_reading[60][2])?> usually manufactures some of the glitteriest cultured ones while the nation such as <b>(22)</b><?= soal_isian_ielts("jawaban_reading[21]", $listening_reading[61][1], $listening_reading[61][2])?>.produces the larger sized pearl due to the favorable environment along the world’s best pearls. In the past, one country of <b>(23)</b><?= soal_isian_ielts("jawaban_reading[22]", $listening_reading[62][1], $listening_reading[62][2])?> in Gulf produced the world's best pearls belongs to India. Nowadays, the major remaining suppliers of natural pearls belong to India.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>28. Description of one family member persuading another of selling cleaning products. <?= soal_isian_ielts("jawaban_reading[27]", $listening_reading[67][1], $listening_reading[67][2])?></p>
                                                        <p>29. An account of the cooperation of all factory staff to cope with sales increase. <?= soal_isian_ielts("jawaban_reading[28]", $listening_reading[68][1], $listening_reading[68][2])?></p>
                                                        <p>30. An account of the creation of the formula of Shower Power. <?= soal_isian_ielts("jawaban_reading[29]", $listening_reading[69][1], $listening_reading[69][2])?></p>
                                                        <p>31. An account of buying the original OzKleen company. <?= soal_isian_ielts("jawaban_reading[30]", $listening_reading[70][1], $listening_reading[70][2])?></p>
                                                        <p>32. Description of Shower Power’s international expansion. <?= soal_isian_ielts("jawaban_reading[31]", $listening_reading[71][1], $listening_reading[71][2])?></p>
                                                        <p>33. The reason of changing the packaging size of Shower Power. <?= soal_isian_ielts("jawaban_reading[32]", $listening_reading[72][1], $listening_reading[72][2])?></p>
                                                        <p>34. An example of some innovative ideas. <?= soal_isian_ielts("jawaban_reading[33]", $listening_reading[73][1], $listening_reading[73][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>35. Grant Keamey <?= soal_isian_ielts("jawaban_reading[34]", $listening_reading[74][1], $listening_reading[74][2])?></p>
                                                        <p>36. Tom Quinn <?= soal_isian_ielts("jawaban_reading[35]", $listening_reading[75][1], $listening_reading[75][2])?></p>
                                                        <p>37. Peter Quinn <?= soal_isian_ielts("jawaban_reading[36]", $listening_reading[76][1], $listening_reading[76][2])?></p>
                                                        <p>38. Belinda McDonnell <?= soal_isian_ielts("jawaban_reading[37]", $listening_reading[77][1], $listening_reading[77][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
