                            ...
                            <div class="sesi-listening" style="display:nones">
                                    ...
                                    <div class="card-body ps-4">
                                        ...
                                        <center>
                                            <table class="table" style="width:100%">
                                                ...
                                                <tr>
                                                    <td>
                                                        <p>Start of run: in front of the 1<?= soal_isian_ielts("jawaban_listening[0]", $listening_reading[0][1], $listening_reading[0][2])?>.</p>
                                                        <p>Time of start: 2<?= soal_isian_ielts("jawaban_listening[1]", $listening_reading[1][1], $listening_reading[1][2])?>.</p>
                                                        <p>Length of run: 3<?= soal_isian_ielts("jawaban_listening[2]", $listening_reading[2][1], $listening_reading[2][2])?>.</p>
                                                        <p>At end of run: volunteer scans 4<?= soal_isian_ielts("jawaban_listening[3]", $listening_reading[3][1], $listening_reading[3][2])?>.</p>
                                                        <p>Best way to register: on the 5<?= soal_isian_ielts("jawaban_listening[4]", $listening_reading[4][1], $listening_reading[4][2])?>.</p>
                                                        <p>Cost of run: 6￡<?= soal_isian_ielts("jawaban_listening[5]", $listening_reading[5][1], $listening_reading[5][2])?>.</p>
                                                    </td>
                                                </tr>
                                            </table>
                                    </div>
                                    ...
                                    <div class="card-body ps-4">
                                        ...
                                        <table class="table" style="width:100%">
                                            <tr>
                                                <td>
                                                    <h3>Volunteering</h3>
                                                    <p>Contact name: Pete 7<?= soal_isian_ielts("jawaban_listening[6]", $listening_reading[6][1], $listening_reading[6][2])?>.</p>
                                                    <p>Phone number: 8<?= soal_isian_ielts("jawaban_listening[7]", $listening_reading[7][1], $listening_reading[7][2])?>.</p>
                                                    <p>Activities: setting up course</p>
                                                    <p>9<?= soal_isian_ielts("jawaban_listening[8]", $listening_reading[8][1], $listening_reading[8][2])?>the runners</p>
                                                    <p>10 <?= soal_isian_ielts("jawaban_listening[9]", $listening_reading[9][1], $listening_reading[9][2])?>for the weekly report </p>
                                                </td>
                                            </tr>
                                        </table>
                                    </div>
                                    ...
                                    <div class="card-body ps-4">
                                        ...
                                        <table class="table" style="width:100%">
                                            ...
                                            <tr>
                                                <td>Bus stop 2</td>
                                                <td>the aquarium</td>
                                                <td>dolphins and 11<?= soal_isian_ielts("jawaban_listening[10]", $listening_reading[10][1], $listening_reading[10][2])?>.</td>
                                            </tr>
                                            <tr>
                                                <td>Bus stop 3</td>
                                                <td>12<?= soal_isian_ielts("jawaban_listening[11]", $listening_reading[11][1], $listening_reading[11][2])?></td>
                                                <td>yachts and power boats</td>
                                            </tr>
                                            <tr>
                                                <td>Bus stop 4</td>
                                                <td>13<?= soal_isian_ielts("jawaban_listening[12]", $listening_reading[12][1], $listening_reading[12][2])?> centre</td>
                                                <td>very old 14<?= soal_isian_ielts("jawaban_listening[13]", $listening_reading[13][1], $listening_reading[13][2])?>.</td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p>15. You need to have a<?= soal_isian_ielts("jawaban_listening[14]", $listening_reading[14][1], $listening_reading[14][2])?>to buy a ticket for ￡10.</p>
                                        <p>16. The bus tour lasts<?= soal_isian_ielts("jawaban_listening[15]", $listening_reading[15][1], $listening_reading[15][2])?>in total.</p>
                                        <p>17. The cost of the bus ticket includes entrance to the<?= soal_isian_ielts("jawaban_listening[16]", $listening_reading[16][1], $listening_reading[16][2])?>.</p>
                                        <p>18. You can listen to an audio commentary which has been made by the<?= soal_isian_ielts("jawaban_listening[17]", $listening_reading[17][1], $listening_reading[17][2])?>.</p>
                                        <p>19. If the weather is wet, it is a good idea to bring<?= soal_isian_ielts("jawaban_listening[18]", $listening_reading[18][1], $listening_reading[18][2])?>.</p>
                                        <p>20. Don’t forget to bring your<?= soal_isian_ielts("jawaban_listening[19]", $listening_reading[19][1], $listening_reading[19][2])?>when you book online.</p>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>31.</b> Ceramics date back approximately<?= soal_isian_ielts("jawaban_listening[30]", $listening_reading[30][1], $listening_reading[30][2])?>.</p>
                                        <p><b>32.</b> The first figurines were made in the area of <?= soal_isian_ielts("jawaban_listening[31]", $listening_reading[31][1], $listening_reading[31][2])?>.</p>
                                        <p><b>33.</b> Early humans could not use their pots to store <?= soal_isian_ielts("jawaban_listening[32]", $listening_reading[32][1], $listening_reading[32][2])?>.</p>
                                        <p><b>34.</b> The Chinese improved the quality of ceramics by mixing <?= soal_isian_ielts("jawaban_listening[33]", $listening_reading[33][1], $listening_reading[33][2])?>with the clay</p>
                                        <p><b>35.</b> Chinese Porcelain was also called<?= soal_isian_ielts("jawaban_listening[34]", $listening_reading[34][1], $listening_reading[34][2])?>.</p>
                                        <p><b>36.</b> Bottger added quartz and <?= soal_isian_ielts("jawaban_listening[35]", $listening_reading[35][1], $listening_reading[35][2])?> to clay to make porcelain.</p>

                                        <center><h2>Glass</h2></center>

                                        <p><b>37.</b> Glass production is similar to clay ceramics apart from the rate of  <?= soal_isian_ielts("jawaban_listening[36]", $listening_reading[36][1], $listening_reading[36][2])?>.</p>
                                        <p><b>38.</b> The Romans introduced the use of glass to make <?= soal_isian_ielts("jawaban_listening[37]", $listening_reading[37][1], $listening_reading[37][2])?>.</p>

                                        <center><h2>Concrete</h2></center>

                                        <p><b>39.</b> The discovery of concrete is probably due to observing reactions of water and <?= soal_isian_ielts("jawaban_listening[38]", $listening_reading[38][1], $listening_reading[38][2])?>.</p>
                                        <p><b>40.</b> the ability to build large <?= soal_isian_ielts("jawaban_listening[39]", $listening_reading[39][1], $listening_reading[39][2])?> contributed to the success of the Roman Empire</p>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>1. liking the view from the bedroom window <?= soal_isian_ielts("jawaban_reading[0]", $listening_reading[40][1], $listening_reading[40][2])?></p>
                                                        <p>2. finding the receptionists welcoming <?= soal_isian_ielts("jawaban_reading[1]", $listening_reading[41][1], $listening_reading[41][2])?></p>
                                                        <p>3. being pleased with the bedroom <?= soal_isian_ielts("jawaban_reading[2]", $listening_reading[42][1], $listening_reading[42][2])?></p>
                                                        <p>4. becoming confused when booking a room <?= soal_isian_ielts("jawaban_reading[3]", $listening_reading[43][1], $listening_reading[43][2])?></p>
                                                        <p>5. being impressed by the wide choice of food <?= soal_isian_ielts("jawaban_reading[4]", $listening_reading[44][1], $listening_reading[44][2])?></p>
                                                        <p>6. staying in the hotel regularly <?= soal_isian_ielts("jawaban_reading[5]", $listening_reading[45][1], $listening_reading[45][2])?></p>
                                                        <p>7. finding it inconvenient that the hotel was crowded <?= soal_isian_ielts("jawaban_reading[6]", $listening_reading[46][1], $listening_reading[46][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                    ...
                                                    <?php
                                                            $data_soal_8_14 = [
                                                                ...
                                                                [
                                                                    ...
                                                                    "jawaban" => $listening_reading[49][1],
                                                                    "status" => $listening_reading[49][2],
                                                                ],
                                                                [
                                                                    "no" => 11,
                                                                    ...
                                                                    "jawaban" => $listening_reading[50][1],
                                                                    "status" => $listening_reading[50][2],
                                                                ],
                                                                [
                                                                    "no" => 12,
                                                                    ...
                                                                    "jawaban" => $listening_reading[51][1],
                                                                    "status" => $listening_reading[51][2],
                                                                ],
                                                                [
                                                                    "no" => 13,
                                                                    ...
                                                                    "jawaban" => $listening_reading[52][1],
                                                                    "status" => $listening_reading[52][2],
                                                                ],
                                                                [
                                                                    "no" => 14,
                                                                    ...
                                                                    "jawaban" => $listening_reading[53][1],
                                                                    "status" => $listening_reading[53][2],
                                                                ],
                                                            ];
                                                        ?>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>• your letters and (15) <?= soal_isian_ielts("jawaban_reading[14]", $listening_reading[54][1], $listening_reading[54][2])?></p>
                                                        <p>• your phone calls and which websites you have visited</p>
                                                        <p>Rules for monitoring are established by data protection law. This states that employers must carry out a procedure that is known as (16) <?= soal_isian_ielts("jawaban_reading[15]", $listening_reading[55][1], $listening_reading[55][2])?> before introducing monitoring,</p>

                                                        <p><b>In general, monitoring is legal if</b></p>
                                                        <p>• it relates to the business</p>
                                                        <p>• you are using (17) <?= soal_isian_ielts("jawaban_reading[16]", $listening_reading[56][1], $listening_reading[56][2])?> intended for work</p>
                                                        <p>• the worker has been informed</p>


                                                        <p><b>Monitoring may be used</b></p>
                                                        <p>• to evaluate the (18) <?= soal_isian_ielts("jawaban_reading[17]", $listening_reading[57][1], $listening_reading[57][2])?> of your work</p>
                                                        <p>• to stop of find out about (19) <?= soal_isian_ielts("jawaban_reading[18]", $listening_reading[58][1], $listening_reading[58][2])?></p>
                                                        <p>• to stop the possibility of (20) <?= soal_isian_ielts("jawaban_reading[19]", $listening_reading[59][1], $listening_reading[59][2])?> affecting systems</p>
                                                        <p>• to check calls to (21) <?= soal_isian_ielts("jawaban_reading[20]", $listening_reading[60][1], $listening_reading[60][2])?> (these cannot be recorded)</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                ...
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <center>
                                                            <table class="table" style="width: 100%">
                                                                <tr>
                                                                    <td>Fill in the online 22 <?= soal_isian_ielts("jawaban_reading[21]", $listening_reading[61][1], $listening_reading[61][2])?> to get a personal reference code.</td>
                                                                </tr>
                                                            </table>
                                                        </center>
                                                            <?= arrowIcon()?>
                                                        <center>
                                                            <table class="table" style="width: 100%">
                                                                <tr>
                                                                    <td>Create your 23 <?= soal_isian_ielts("jawaban_reading[22]", $listening_reading[62][1], $listening_reading[62][2])?>, and provide the necessary information for the profile in your application.</td>
                                                                </tr>
                                                            </table>
                                                        </center>
                                                            <?= arrowIcon()?>
                                                        <center>
                                                            <table class="table" style="width: 100%">
                                                                <tr>
                                                                    <td>If sent an invitation, you must accept this within 24 <?= soal_isian_ielts("jawaban_reading[23]", $listening_reading[63][1], $listening_reading[63][2])?> . You then have a limited time to 25 <?= soal_isian_ielts("jawaban_reading[24]", $listening_reading[64][1], $listening_reading[64][2])?> the application.</td>
                                                                </tr>
                                                            </table>
                                                        </center>
                                                            <?= arrowIcon()?>
                                                        <center>
                                                            <table class="table" style="width: 100%">
                                                                <tr>
                                                                    <td>Your 26 <?= soal_isian_ielts("jawaban_reading[25]", $listening_reading[65][1], $listening_reading[65][2])?> is required to send you an offer of employment number.</td>
                                                                </tr>
                                                            </table>
                                                        </center>
                                                            <?= arrowIcon()?>
                                                        ...
                                                        <center>
                                                            <table class="table" style="width: 100%">
                                                                <tr>
                                                                    <td>Make the payment for participation online. You may receive a 27 <?= soal_isian_ielts("jawaban_reading[26]", $listening_reading[66][1], $listening_reading[66][2])?> later if you change your mind.</td>
                                                                </tr>
                                                            </table>
                                                        </center>
                                                            <?= arrowIcon()?>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>33.</b> A particular crop may make an important contribution to the local economy in one African country. <?= soal_isian_ielts("jawaban_reading[32]", $listening_reading[72][1], $listening_reading[72][2])?></p>
                                                        <p><b>34.</b> Tests will be carried out by local people in the country where the research is focused. <?= soal_isian_ielts("jawaban_reading[33]", $listening_reading[73][1], $listening_reading[73][2])?></p>
                                                        <p><b>35.</b> Different specialists must work together to ensure the success of a programme. <?= soal_isian_ielts("jawaban_reading[34]", $listening_reading[74][1], $listening_reading[74][2])?></p>
                                                        <p><b>36.</b> One type of insect attacking plants in Ghana was previously unknown there. <?= soal_isian_ielts("jawaban_reading[35]", $listening_reading[75][1], $listening_reading[75][2])?></p>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>Trypanosomiasis is a disease caused by a parasite which is spread by an insect called the (37) <?= soal_isian_ielts("jawaban_reading[36]", $listening_reading[76][1], $listening_reading[76][2])?> The parasite can remain unaffected by the host’s (38) <?= soal_isian_ielts("jawaban_reading[37]", $listening_reading[77][1], $listening_reading[77][2])?> because it is able to change the (39) <?= soal_isian_ielts("jawaban_reading[38]", $listening_reading[78][1], $listening_reading[78][2])?> on its outer covering. It is uncommon among humans but has been found to affect most (40) <?= soal_isian_ielts("jawaban_reading[39]", $listening_reading[79][1], $listening_reading[79][2])?> in Ghana.</p>
