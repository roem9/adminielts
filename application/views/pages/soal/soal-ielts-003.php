                            ...
                            <div class="sesi-listening" style="display:nones">
                                        ...
                                        <center>
                                            <table class="table" style="width:100%">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>at <b>1</b><?= soal_isian_ielts("jawaban_listening[0]", $listening_reading[0][1], $listening_reading[0][2])?> pm on Tuesdays</td>
                                                    <td>water jar and set of <b>2</b><?= soal_isian_ielts("jawaban_listening[1]", $listening_reading[1][1], $listening_reading[1][2])?></td>
                                                    <td>£45 – four classes</td>
                                                </tr>
                                                <tr>
                                                    <td>Maori language</td>
                                                    <td>the small room at the <b>3</b><?= soal_isian_ielts("jawaban_listening[2]", $listening_reading[2][1], $listening_reading[2][2])?> of the building</td>
                                                    <td>starts in <b>4</b><?= soal_isian_ielts("jawaban_listening[3]", $listening_reading[3][1], $listening_reading[3][2])?></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>the <b>5</b><?= soal_isian_ielts("jawaban_listening[4]", $listening_reading[4][1], $listening_reading[4][2])?> for the camera</td>
                                                    <td><b>6</b> £<?= soal_isian_ielts("jawaban_listening[5]", $listening_reading[5][1], $listening_reading[5][2])?> – eight classes</td>
                                                </tr>
                                            </table>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>7.</b> The watercolours class suits people who are<?= soal_isian_ielts("jawaban_listening[6]", $listening_reading[6][1], $listening_reading[6][2])?></p>
                                        <p><b>8.</b> To find out about the Maori language class, contact Jason<?= soal_isian_ielts("jawaban_listening[7]", $listening_reading[7][1], $listening_reading[7][2])?></p>
                                        <p><b>9.</b> For the photography class, check the<?= soal_isian_ielts("jawaban_listening[8]", $listening_reading[8][1], $listening_reading[8][2])?> for the camera.</p>
                                        <p><b>10.</b> There is a trip to a local<?= soal_isian_ielts("jawaban_listening[9]", $listening_reading[9][1], $listening_reading[9][2])?> in the final week of the photography class.</p>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>11.</b> <?= soal_isian_ielts("jawaban_listening[10]", $listening_reading[10][1], $listening_reading[10][2])?></p>
                                        <p><b>12.</b> <?= soal_isian_ielts("jawaban_listening[11]", $listening_reading[11][1], $listening_reading[11][2])?></p>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>13.</b> <?= soal_isian_ielts("jawaban_listening[12]", $listening_reading[12][1], $listening_reading[12][2])?></p>
                                        <p><b>14.</b> <?= soal_isian_ielts("jawaban_listening[13]", $listening_reading[13][1], $listening_reading[13][2])?></p>
                                    </div>
                                </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-4">
                                                <p>15. Vegetable beds <?= soal_isian_ielts("jawaban_listening[14]", $listening_reading[14][1], $listening_reading[14][2])?>.</p>
                                                <p>16. Bee hives <?= soal_isian_ielts("jawaban_listening[15]", $listening_reading[15][1], $listening_reading[15][2])?>.</p>
                                                <p>17. Seating <?= soal_isian_ielts("jawaban_listening[16]", $listening_reading[16][1], $listening_reading[16][2])?>.</p>
                                                <p>18. Adventure playground <?= soal_isian_ielts("jawaban_listening[17]", $listening_reading[17][1], $listening_reading[17][2])?>.</p>
                                                <p>19. Sand area <?= soal_isian_ielts("jawaban_listening[18]", $listening_reading[18][1], $listening_reading[18][2])?>.</p>
                                                <p>20. Pond <?= soal_isian_ielts("jawaban_listening[19]", $listening_reading[19][1], $listening_reading[19][2])?>.</p>
                                            </div>
                                        </div>
                                ...
                                <div class="shadow card mb-3">
                                    <div class="card-body ps-4">
                                        ...
                                        <p><b>26.</b> edible patch <?= soal_isian_ielts("jawaban_listening[25]", $listening_reading[25][1], $listening_reading[19][2])?>.</p>
                                        <p><b>27.</b> ripeness sector <?= soal_isian_ielts("jawaban_listening[26]", $listening_reading[26][1], $listening_reading[19][2])?>.</p>
                                        <p><b>28.</b> waste tracking technology <?= soal_isian_ielts("jawaban_listening[27]", $listening_reading[27][1], $listening_reading[19][2])?>.</p>
                                        <p><b>29.</b> smartphone application <?= soal_isian_ielts("jawaban_listening[28]", $listening_reading[28][1], $listening_reading[19][2])?>.</p>
                                        <p><b>30.</b> food waste composting <?= soal_isian_ielts("jawaban_listening[29]", $listening_reading[29][1], $listening_reading[19][2])?>.</p>
                                    </div>
                                </div>
                                        ...
                                        <table class="table">
                                            <tr>
                                                <td>
                                                    ...
                                                    <p>– 31<?= soal_isian_ielts("jawaban_listening[30]", $listening_reading[30][1], $listening_reading[19][2])?>. was not allowed during a kite’s preparation</p>

                                                    <p><b>Kites:</b></p>
                                                    <p>– often represented a bird, a god, or a 32<?= soal_isian_ielts("jawaban_listening[31]", $listening_reading[31][1], $listening_reading[19][2])?>.</p>
                                                    <p>– had frames that were decorated with grasses and 33<?= soal_isian_ielts("jawaban_listening[32]", $listening_reading[32][1], $listening_reading[19][2])?>.</p>
                                                    <p>– had a line of noisy 34<?= soal_isian_ielts("jawaban_listening[33]", $listening_reading[33][1], $listening_reading[19][2])?>. attached to them.</p>
                                                    <p>– could be triangular, rectangular or 35<?= soal_isian_ielts("jawaban_listening[34]", $listening_reading[34][1], $listening_reading[19][2])?>.</p>
                                                    <p>– had patterns made from clay mixed with 36<?= soal_isian_ielts("jawaban_listening[35]", $listening_reading[35][1], $listening_reading[19][2])?>.</p>
                                                    <p>– sometimes had human-head masks with 37<?= soal_isian_ielts("jawaban_listening[36]", $listening_reading[36][1], $listening_reading[19][2])?>. and a tattoo.</p>

                                                    <p><b>Purpose and function of kites:</b></p>
                                                    <p>– a way of sending 38<?= soal_isian_ielts("jawaban_listening[37]", $listening_reading[37][1], $listening_reading[19][2])?>. to the gods</p>
                                                    <p>– a way of telling other villages that a 39<?= soal_isian_ielts("jawaban_listening[38]", $listening_reading[38][1], $listening_reading[19][2])?>. was necessary</p>
                                                    <p>– a means of 40<?= soal_isian_ielts("jawaban_listening[39]", $listening_reading[39][1], $listening_reading[19][2])?>. if enemies were coming.</p>
                                                </td>
                                            </tr>
                                        </table>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>1.</b> reference to research showing the beneficial effects of oxytocin on people <?= soal_isian_ielts("jawaban_reading[0]", $listening_reading[40][1], $listening_reading[40][2])?></p>
                                                        <p><b>2.</b> reasons why the effects of oxytocin are complex <?= soal_isian_ielts("jawaban_reading[1]", $listening_reading[41][1], $listening_reading[41][2])?></p>
                                                        <p><b>3.</b> mention of a period in which oxytocin attracted little scientific attention <?= soal_isian_ielts("jawaban_reading[2]", $listening_reading[42][1], $listening_reading[42][2])?></p>
                                                        <p><b>4.</b> reference to people ignoring certain aspects of their research data <?= soal_isian_ielts("jawaban_reading[3]", $listening_reading[43][1], $listening_reading[43][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>5.</b> People are more trusting when affected by oxytocin.<?= soal_isian_ielts("jawaban_reading[4]", $listening_reading[44][1], $listening_reading[44][2])?></p>
                                                        <p><b>6.</b> Oxytocin increases people’s feelings of jealousy.<?= soal_isian_ielts("jawaban_reading[5]", $listening_reading[45][1], $listening_reading[45][2])?></p>
                                                        <p><b>7.</b> The effect of oxytocin varies from one type of person to another.<?= soal_isian_ielts("jawaban_reading[6]", $listening_reading[46][1], $listening_reading[46][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>The earliest findings about oxytocin and bonding came from research involving <b>8</b><?= soal_isian_ielts("jawaban_reading[7]", $listening_reading[47][1], $listening_reading[47][2])?>. It was also discovered that humans produce oxytocin during <b>9</b><?= soal_isian_ielts("jawaban_reading[8]", $listening_reading[48][1], $listening_reading[48][2])?> An experiment in 2005, in which participants were given either oxytocin or a <b>10</b><?= soal_isian_ielts("jawaban_reading[9]", $listening_reading[49][1], $listening_reading[49][2])?>, reinforced the belief that the hormone had a positive effect.</p>
                                                        <p>However, later research suggests that this is not always the case. A study at the University of Haifa where participants took part in a <b>11</b><?= soal_isian_ielts("jawaban_reading[10]", $listening_reading[50][1], $listening_reading[50][2])?>. revealed the negative emotions which oxytocin can trigger. A study at the University of Antwerp showed people’s lack of willingness to help <b>12</b><?= soal_isian_ielts("jawaban_reading[11]", $listening_reading[51][1], $listening_reading[51][2])?>. while under the influence of oxytocin. Meanwhile, research at the University of Amsterdam revealed that people who have been given oxytocin consider <b>13</b><?= soal_isian_ielts("jawaban_reading[12]", $listening_reading[52][1], $listening_reading[52][2])?>. that are familiar to them in their own country to have more positive associations than those from other cultures.</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                                        ...
                                                        <?php
                                                            $data_soal_14_19 = [
                                                                ...
                                                                [
                                                                    ...
                                                                    "jawaban" => $listening_reading[54][1],
                                                                    "status" => $listening_reading[54][2],
                                                                ],
                                                                [
                                                                    "no" => 16,
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>20.</b> <?= soal_isian_ielts("jawaban_reading[19]", $listening_reading[59][1], $listening_reading[59][2])?></p>
                                                        <p><b>21.</b> <?= soal_isian_ielts("jawaban_reading[20]", $listening_reading[60][1], $listening_reading[60][2])?></p>
                                                        <p><b>22.</b> <?= soal_isian_ielts("jawaban_reading[21]", $listening_reading[61][1], $listening_reading[61][2])?></p>
                                                        <p><b>23.</b> <?= soal_isian_ielts("jawaban_reading[22]", $listening_reading[62][1], $listening_reading[62][2])?></p>
                                                        <p><b>24.</b> <?= soal_isian_ielts("jawaban_reading[23]", $listening_reading[63][1], $listening_reading[63][2])?></p>
                                                        <p><b>25.</b> <?= soal_isian_ielts("jawaban_reading[24]", $listening_reading[64][1], $listening_reading[64][2])?></p>
                                                        <p><b>26.</b> <?= soal_isian_ielts("jawaban_reading[25]", $listening_reading[65][1], $listening_reading[65][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>The discipline of neuroaesthetics aims to bring scientific objectivity to the study of art. Neurological studies of the brain, for example, demonstrate the impact which Impressionist paintings have on our <b>31</b> <?= soal_isian_ielts("jawaban_reading[30]", $listening_reading[70][1], $listening_reading[70][2])?>. Alex Forsythe of the University of Liverpool believes many artists give their works the precise degree of <b>32</b> <?= soal_isian_ielts("jawaban_reading[31]", $listening_reading[71][1], $listening_reading[71][2])?>. which most appeals to the viewer’s brain. She also observes that pleasing works of art often contain certain repeated <b>33</b> <?= soal_isian_ielts("jawaban_reading[32]", $listening_reading[72][1], $listening_reading[72][2])?>. which occur frequently in the natural world.</p>
