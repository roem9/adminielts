                            ...
                            <div class="sesi-listening" style="display:nones">
                                ...
                                <div class="shadow card mb-3 soal">
                                    <div class="card-body ps-4">
                                        ...
                                        <ul type="bullet">
                                            <li>someone in an anxiety state has worse <b>31)</b> <?= soal_isian_ielts("jawaban_listening[30]", $listening_reading[30][1], $listening_reading[30][2])?></li>
                                            <li>a phobia may stem from heredity or <b>32)</b> <?= soal_isian_ielts("jawaban_listening[31]", $listening_reading[31][1], $listening_reading[31][2])?> problems</li>
                                            <li>the reason for the final breakdown is generally linked with <b>33)</b> <?= soal_isian_ielts("jawaban_listening[32]", $listening_reading[32][1], $listening_reading[32][2])?> occurrences</li>
                                        </ul>
                                        <p><b>Phobic states:</b></p>
                                        <ul type="bullet">
                                            <li>Agoraphobia		: fears leaving the home <b>34)</b> <?= soal_isian_ielts("jawaban_listening[33]", $listening_reading[33][1], $listening_reading[33][2])?></li>
                                            <li>Claustrophobia	: fears small <b>35)</b> <?= soal_isian_ielts("jawaban_listening[34]", $listening_reading[34][1], $listening_reading[34][2])?></li>
                                            <li>
                                            Social phobia		: <br>
                                                                a. feels extremely shy in the <b>36)</b> <?= soal_isian_ielts("jawaban_listening[35]", $listening_reading[35][1], $listening_reading[35][2])?> of people<br>
                                                                b. becomes <b>37)</b> <?= soal_isian_ielts("jawaban_listening[36]", $listening_reading[36][1], $listening_reading[36][2])?> in front of other people<br>
                                                                c. gets sweaty <b>38)</b> <?= soal_isian_ielts("jawaban_listening[37]", $listening_reading[37][1], $listening_reading[37][2])?> of the body
                                            </li>
                                            <li>
                                                Single phobia		: <br>
                                                                    a. has a deep-seated <b>39)</b> <?= soal_isian_ielts("jawaban_listening[38]", $listening_reading[38][1], $listening_reading[38][2])?> to particular creatures<br>
                                                                    b. fears of the <b>40)</b> <?= soal_isian_ielts("jawaban_listening[39]", $listening_reading[39][1], $listening_reading[39][2])?>
                                            </li>
                                                        ...
                                                        <?php
                                                            $data_soal_1_6 = [
                                                                [ 
                                                                    ...
                                                                    "jawaban" => $listening_reading[40][1],
                                                                    "status" => $listening_reading[40][2],
                                                                ],
                                                                [ 
                                                                    "no" => 2, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[41][1],
                                                                    "status" => $listening_reading[41][2],
                                                                ],
                                                                [ 
                                                                    "no" => 3, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[42][1],
                                                                    "status" => $listening_reading[42][2],
                                                                ],
                                                                [ 
                                                                    "no" => 4, 
                                                                    ...
                                                                    "jawaban" => $listening_reading[43][1],
                                                                    "status" => $listening_reading[43][2],
                                                                ],
                                                                [ 
                                                                    "no" => 5, 
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>7.</b> The zips on this cabin bag may be difficult to use. <?= soal_isian_ielts("jawaban_reading[6]", $listening_reading[46][1], $listening_reading[46][2])?></p>
                                                        <p><b>8.</b> This cabin bag may be badly damaged if it is dropped. <?= soal_isian_ielts("jawaban_reading[7]", $listening_reading[47][1], $listening_reading[47][2])?></p>
                                                        <p><b>9.</b> The handles of this cabin bag have a number of different problems. <?= soal_isian_ielts("jawaban_reading[8]", $listening_reading[48][1], $listening_reading[48][2])?></p>
                                                        <p><b>10.</b> This cabin bag is very resistant to water. <?= soal_isian_ielts("jawaban_reading[9]", $listening_reading[49][1], $listening_reading[49][2])?></p>
                                                        <p><b>11.</b> There’s a good choice of patterns for the fabric of this cabin bag. <?= soal_isian_ielts("jawaban_reading[10]", $listening_reading[50][1], $listening_reading[50][2])?></p>
                                                        <p><b>12.</b> This cabin bag isn’t very easy to move around. <?= soal_isian_ielts("jawaban_reading[11]", $listening_reading[51][1], $listening_reading[51][2])?></p>
                                                        <p><b>13.</b> This cabin bag has just one internal zipped pocket. <?= soal_isian_ielts("jawaban_reading[12]", $listening_reading[52][1], $listening_reading[52][2])?></p>
                                                        <p><b>14.</b> The trolley handle of this cabin bag is adjustable <?= soal_isian_ielts("jawaban_reading[13]", $listening_reading[53][1], $listening_reading[53][2])?></p>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>15.</b> Where can you buy parking permits at the college? <?= soal_isian_ielts("jawaban_reading[14]", $listening_reading[54][1], $listening_reading[54][2])?></p>
                                                        <p><b>16.</b> Which document shows the dates of term time? <?= soal_isian_ielts("jawaban_reading[15]", $listening_reading[55][1], $listening_reading[55][2])?></p>
                                                        <p><b>17.</b> What is the start date of annual parking permits? <?= soal_isian_ielts("jawaban_reading[16]", $listening_reading[56][1], $listening_reading[56][2])?></p>
                                                        <p><b>18.</b> Who is responsible for giving out parking fines if you park in the wrong place? <?= soal_isian_ielts("jawaban_reading[17]", $listening_reading[57][1], $listening_reading[57][2])?></p>
                                                        <p><b>19.</b> What do visitors need to show when parking? <?= soal_isian_ielts("jawaban_reading[18]", $listening_reading[58][1], $listening_reading[58][2])?></p>
                                                        <p><b>20.</b> Where can the nursery pick-up point be found? <?= soal_isian_ielts("jawaban_reading[19]", $listening_reading[59][1], $listening_reading[59][2])?></p>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>21.</b> What is the minimum period you must have worked for an employer in order to be eligible for SMP? <?= soal_isian_ielts("jawaban_reading[20]", $listening_reading[60][1], $listening_reading[60][2])?></p>
                                                        <p><b>22.</b> For how long is SMP payable every week as a percentage of your average weekly earnings? <?= soal_isian_ielts("jawaban_reading[21]", $listening_reading[61][1], $listening_reading[61][2])?></p>
                                                        <p><b>23.</b> What sum is payable every week as the second part of SMP entitlement? <?= soal_isian_ielts("jawaban_reading[22]", $listening_reading[62][1], $listening_reading[62][2])?></p>
                                                        <p><b>24.</b> What is the maximum length of time MA is payable? <?= soal_isian_ielts("jawaban_reading[23]", $listening_reading[63][1], $listening_reading[63][2])?></p>
                                                        <p><b>25.</b> Where can MA forms be obtained? <?= soal_isian_ielts("jawaban_reading[24]", $listening_reading[64][1], $listening_reading[64][2])?></p>
                                                        <p><b>26.</b> Apart from income, what else is considered when assessing how much Child Tax Credit is paid? <?= soal_isian_ielts("jawaban_reading[25]", $listening_reading[65][1], $listening_reading[65][2])?></p>
                                                        <p><b>27.</b> What are Sure Start Maternity Payments? <?= soal_isian_ielts("jawaban_reading[26]", $listening_reading[66][1], $listening_reading[66][2])?></p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p><b>28.</b> Section A <?= soal_isian_ielts("jawaban_reading[27]", $listening_reading[67][1], $listening_reading[67][2])?></p>
                                                        <p><b>29.</b> Section B <?= soal_isian_ielts("jawaban_reading[28]", $listening_reading[68][1], $listening_reading[68][2])?></p>
                                                        <p><b>30.</b> Section C <?= soal_isian_ielts("jawaban_reading[29]", $listening_reading[69][1], $listening_reading[69][2])?></p>
                                                        <p><b>31.</b> Section D <?= soal_isian_ielts("jawaban_reading[30]", $listening_reading[70][1], $listening_reading[70][2])?></p>
                                                        <p><b>32.</b> Section E <?= soal_isian_ielts("jawaban_reading[31]", $listening_reading[71][1], $listening_reading[71][2])?></p>
                                            ...
                                            <div class="col-5">
                                                <div class="card">
                                                    <div class="card-body ps-4" style="height: 600px; overflow: scroll">
                                                        ...
                                                        <p>
                                                            Papyrus is rich in cellulose and in some conditions will be destroyed by fungal growths or be consumed by <b>(38)</b> <?= soal_isian_ielts("jawaban_reading[37]", $listening_reading[77][1], $listening_reading[77][2])?>. However, it can survive for long periods in an environment that is dry. It has been found in a 5,000-year-old <b>(39)</b> <?= soal_isian_ielts("jawaban_reading[38]", $listening_reading[78][1], $listening_reading[78][2])?>. in Egypt, and in Herculaneum many papyrus documents were preserved following a huge <b>(40)</b> <?= soal_isian_ielts("jawaban_reading[39]", $listening_reading[79][1], $listening_reading[79][2])?>. in 79 CE. in the town of Oxyrhynchus, unwanted administrative documents were left on rubbish dumps which were covered with sand, preserving them for many years.
                                                        </p>
                                                    </div>
                                                </div>
                                            </div>
